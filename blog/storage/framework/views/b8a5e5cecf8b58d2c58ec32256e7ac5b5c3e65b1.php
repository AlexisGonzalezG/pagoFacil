...
<html lang="en">
    ...
    <body>
        ...
        <div class="container text-center shadow-lg p-3 mb-5 bg-body rounded">
            <img id="img_cargando" src="<?php echo e(URL::asset('img/cargando.gif')); ?>" width="250" style="display: none;" />
            <div class="row">
                <div class="col">
...
</html><?php /**PATH C:\xampp\htdocs\blog\resources\views/pagoFacil/index.blade.php ENDPATH**/ ?>